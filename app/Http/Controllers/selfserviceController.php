...
class selfserviceController extends Controller
{
    ...
    {
        $user = auth()->user();
        $query = selfservice::with(['modificationField', 'transaction'])
        ...
        $ninService = Service::where('name', 'selfservice')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('selfservice')->with([
                'status' => 'success',
