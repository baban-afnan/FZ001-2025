                        ...
                        <div class="card-body ">
                            <div class="alert alert-danger shadow-sm">
                                <center><svg class="d-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    <p> Note that &#x20A6; fee will be deducted from your
                                        wallet balance for each successful verification.
                                        there will be no charges on instances where the NIN is not successfully verified or
                                        if the data is not found.</p>
                                    <p> Please confirm you have sufficient funds in your wallet before proceeding with the
                                        verification.</p>
                                </center>
                            </div>
