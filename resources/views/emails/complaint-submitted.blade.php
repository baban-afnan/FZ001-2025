...
<head>
  ...
  <title>Support Ticket Confirmation - Fee24MFB</title>
  ...
  <div class="container">
    <div class="email-wrapper">
      ...
      <div class="header">
        ...
        <h1 class="title">Support Ticket Received</h1>
        <p class="subtitle">
          Dear <span class="highlight">{{ Auth::user()->first_name ?? 'User' }}</span>,<br>
          Your request has been logged successfully. Below are your ticket details:
        </p>
      </div>
      ...
      <table class="ticket-details">
        ...
        <tr>
          ...
          <td>{{ $ticket->transaction_ref }}</td>
        </tr>
        <tr>
          <th>Complaint</th>
          <td>{{ ucfirst($ticket->content) }}</td>
        </tr>
        <tr>
          <th>Category</th>
        ...
        <tr>
          <th>Status</th>
          <td><span class="status status-open">{{ ucfirst($ticket->status) }}</span></td>
        </tr>
      </table>
