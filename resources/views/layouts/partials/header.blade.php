<div class="page-wrapper compact-wrapper" id="pageWrapper"> 
  ...
  <div class="logo-wrapper d-flex align-items-center col-auto">
    ...
    <img class="dark-logo img-fluid d-none" 
         src="{{ asset('assets/images/logo/logo-dark.png') }}" 
         alt="logo" 
         style="max-width: 35px; height: auto;" />

    <a class="close-btn toggle-sidebar ms-3 text-muted" href="javascript:void(0)">
          ...
          <div class="Typeahead Typeahead--twitterUsers">
            <div class="u-posRelative">
              <input class="demo-input Typeahead-input form-control-plaintext w-100" 
                     type="text" placeholder="Search Admiro .." name="q" autofocus="autofocus"/>
